...
ClassImp(TSVDUnfold_local)

using namespace std;

//_______________________________________________________________________
TSVDUnfold_local::TSVDUnfold_local( const TH1D *bdat, const TH1D *bini, const TH1D *xini, const TH2D *Adet )
: TObject     (),
fNdim       (0),
fDdim       (2),
fNormalize  (kFALSE),
...
//_______________________________________________________________________
TSVDUnfold_local::TSVDUnfold_local( const TH1D *bdat, TH2D* Bcov, const TH1D *bini, const TH1D *xini, const TH2D *Adet )
: TObject     (),
fNdim       (0),
fDdim       (2),
fNormalize  (kFALSE),
...
{
   // Default constructor
   // Initialisation of TSVDUnfold_local
...
//_______________________________________________________________________
TSVDUnfold_local::TSVDUnfold_local( const TSVDUnfold_local& other )
: TObject     ( other ),
fNdim       (other.fNdim),
fDdim       (other.fDdim),
...
//_______________________________________________________________________
TSVDUnfold_local::~TSVDUnfold_local()
{
   // Destructor
   if(fToyhisto){
      delete fToyhisto;
...
//_______________________________________________________________________
TH1D* TSVDUnfold_local::Unfold( Int_t kreg )
{
...
//_______________________________________________________________________
TH2D* TSVDUnfold_local::GetUnfoldCovMatrix( const TH2D* cov, Int_t ntoys, Int_t seed )
{
...
//_______________________________________________________________________
TH2D* TSVDUnfold_local::GetAdetCovMatrix( Int_t ntoys, Int_t seed )
{
...
//_______________________________________________________________________
TH1D* TSVDUnfold_local::GetD() const
{
...
//_______________________________________________________________________
TH1D* TSVDUnfold_local::GetSV() const
{
...
//_______________________________________________________________________
TH2D* TSVDUnfold_local::GetXtau() const
{
...
//_______________________________________________________________________
TH2D* TSVDUnfold_local::GetXinv() const
{
...
//_______________________________________________________________________
TH2D* TSVDUnfold_local::GetBCov() const
{
...
//_______________________________________________________________________
void TSVDUnfold_local::H2V( const TH1D* histo, TVectorD& vec )
{
...
//_______________________________________________________________________
void TSVDUnfold_local::H2Verr( const TH1D* histo, TVectorD& vec )
{
...
//_______________________________________________________________________
void TSVDUnfold_local::V2H( const TVectorD& vec, TH1D& histo )
{
...
//_______________________________________________________________________
void TSVDUnfold_local::H2M( const TH2D* histo, TMatrixD& mat )
{
...
//_______________________________________________________________________
void TSVDUnfold_local::M2H( const TMatrixD& mat, TH2D& histo )
{
   // Fill 2D histogram into matrix
...
//_______________________________________________________________________
TVectorD TSVDUnfold_local::VecDiv( const TVectorD& vec1, const TVectorD& vec2, Int_t zero )
{
...
//_______________________________________________________________________
TMatrixD TSVDUnfold_local::MatDivVec( const TMatrixD& mat, const TVectorD& vec, Int_t zero )
{
...
//_______________________________________________________________________
TVectorD TSVDUnfold_local::CompProd( const TVectorD& vec1, const TVectorD& vec2 )
{
...
//_______________________________________________________________________
Double_t TSVDUnfold_local::GetCurvature(const TVectorD& vec, const TMatrixD& curv)
{
...
//_______________________________________________________________________
void TSVDUnfold_local::FillCurvatureMatrix( TMatrixD& tCurv, TMatrixD& tC ) const
{
...
//_______________________________________________________________________
void TSVDUnfold_local::InitHistos( )
{
...
//_______________________________________________________________________
void TSVDUnfold_local::RegularisedSymMatInvert( TMatrixDSym& mat, Double_t eps )
{
...
//_______________________________________________________________________
Double_t TSVDUnfold_local::ComputeChiSquared( const TH1D& truspec, const TH1D& unfspec)
{
