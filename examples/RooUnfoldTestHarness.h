...
//      $Id: RooUnfoldTestHarness.h,v 1.26 2010-08-10 16:10:25 fwx38934 Exp $
//
// Description:
...
public:
  ...
  Int_t    ntoyssvd, nmx, onepage, doerror, dim, overflow, dosmear, nbPDF, verbose, dodraw, ntoys,ploterrors,plotparms;
